...
Available TLOs:
	...
	${sqlite.resultcode[QueryName]} -- Int - SQLite ResultCode (or -1: Active, -2: No Query Found)
		SQLite Result Codes can be found here: https://www.sqlite.org/c3ref/c_abort.html
Example:
